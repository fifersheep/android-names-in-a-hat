...
interface DbHelper {
    ...
    fun createGroup(classroomName: String): Long
    ...
    fun addClassroom(classroomName: String, pupils: List<String>)
    fun editGroupNames(groupId: Long, pupils: List<String>)
    fun getClassroomId(classroomName: String): Long
    fun sortPupils(groupId: String): Boolean
}
